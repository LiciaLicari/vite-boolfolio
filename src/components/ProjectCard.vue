                ...
                <div class="col" v-for="project in projects.data">
                    <div class="card rounded-0 shadow p-1 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                <a :href="project.link" target="_blank"
                                    class="bn632-hover bn28 btn d-flex align-items-center justify-content-center gap-2 m-0">
                                    <span class="text-dark">Web Site</span>
                        ...
                        <div class="card-footer">
                            <RouterLink :to="project.slug" class="text-white btn btn-dark w-50">
                                View Project
                            </RouterLink>
                        </div>
                    </div>
